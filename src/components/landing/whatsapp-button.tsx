...
export function WhatsAppButton() {
  const advisors = [
    { name: "Asesor 1", phone: "1234567890" }, // Replace with your WhatsApp number
    { name: "Asesor 2", phone: "0987654321" }, // Replace with your WhatsApp number
  ];
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-56 mb-2" side="top" align="end">
           <DropdownMenuItem disabled>
             ...
             <span>Elige un asesor</span>
           </DropdownMenuItem>
          {advisors.map((advisor) => (
            <DropdownMenuItem key={advisor.name} asChild>
              <Link
